...
: ${AMENT_CURRENT_PREFIX:="/home/user/ros2_ws/install/logs_test"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/logs_test/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/logs_test/environment/path.sh"
